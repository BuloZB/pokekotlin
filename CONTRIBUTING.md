...
Run mise install in the project root to install all required tools. Still read
the rest of the guide, because not all tools are managed by mise.
...
The project uses a number of tools for code formatting. You can apply the
formatting rules with:
